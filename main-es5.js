...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _window_ref_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../window-ref.service */
    ...
    /*! @angular/forms */
    "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js"); // const instance = new Razorpay({
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      function HomeComponent(route, afStore, zone, winRef) {
        var _this = this;
        ...
        this.options = {
          ...
          modal: {
            ondismiss: function ondismiss() {
              ...
              _this.zone.run(function () {// add routing if it fails
              });
            }
          }
        };
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.getUserData(); // this.initPay();
        }
      }, {
        key: "addCheckUser",
        value: function addCheckUser() {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.afStore.doc("users/".concat(this.emailId)).set({
        ...
        value: function getUserData() {
          ...
          var data = posts.valueChanges().subscribe(function (res) {
        ...
        value: function clearLocalStorage(event) {
          localStorage.clear();
        }
      }]);
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      hostBindings: function HomeComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("onbeforeunload", function HomeComponent_onbeforeunload_HostBindingHandler($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          ...
          type: _window_ref_service__WEBPACK_IMPORTED_MODULE_4__["WindowRefService"]
        }];
      }, {
        clearLocalStorage: [{
